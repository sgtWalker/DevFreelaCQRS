using DevFreelaCQRS.Core.IntegrationEvents;
...
namespace DevFreelaCQRS.Application.Consumers
{
    public class PaymentApprovedConsumer : BackgroundService
    {
        ...
        protected override Task ExecuteAsync(CancellationToken stoppingToken)
        {
            ...
            {
                var paymentApprovedByte = eventArgs.Body.ToArray();
                var paymentApprovedJson = Encoding.UTF8.GetString(paymentApprovedByte);
        ...
        public async Task FinishProject(Guid projectId)
        {
